        ...
        <div class="row">
          <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
            ...
            <div class="card card-primary">
              <div class="card-header"><h4>Reset Password Keperawatan Polindra</h4></div>
              ...
              <div class="card-body">
                ...
                <div class="row">       
                    ...
                    <div class="form-group col-6">
                        ...
                        <input type="password" class="form-control" name="password" required autofocus placeholder="Masukkan Password Baru">
                        <div class="text-danger">
                                @error('email')
                                    {{ $message }}
                                @enderror
