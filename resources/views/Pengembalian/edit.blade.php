...
<div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">Edit Data Pengembalian</div>
        </div>
    </div>
    <div class="section-body">
        <div class="card">
            <div class="card-body">
                ...
                <form action="/Pengembalian/update/{{ $kem->id }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')    
                    @csrf
                    <div class="row">
                        <div class="form-group col-6 col-md-3 col-lg-3">    
                                <label class="control-label" for="nama_barang">Nama Barang</label>
                                <input type="text" name="nama_barang" class="form-control" value="{{ $kem->nama_barang }}">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-6 col-md-3 col-lg-3">
                            ...
                            <input type="number" name="jumlah_pengembalian" class="form-control" value="{{ $kem->jumlah_pengembalian }}">
                            <div class="text-danger">
					 ...
					 <div class="row">
                        <div class="form-group col-6 col-md-3 col-lg-3">
                            ...
                            <input type="date" name="tanggal_pengembalian" class="form-control" value="{{ $kem->tanggal_pengembalian }}">
                            <div class="text-danger">
