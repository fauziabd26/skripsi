...
<head>
  ...
  <title>Register &mdash; Kalab Keperawatan Polindra</title>
        ...
        <div class="row">
          <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
            ...
            <div class="card card-primary">
              <div class="card-header"><h4>Register Kepala Laboratorium Keperawatan Polindra</h4></div>

              <div class="card-body">
                <form action="{{ route('post_kalab') }}" method="POST">
                @csrf  
                <div class="row">
